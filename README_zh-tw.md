...
<p align="center">
  ...
  <img alt="macOS" src="https://img.shields.io/badge/mac%20os-000000?style=for-the-badge&logo=mapple&logoColor=F0F0F0" />
</p>
...
- [常見問題 (FAQ)](./docs/FAQ_TW.md)

## 貢獻指南

> [!NOTE]
> 貢獻指南內容為英文，請參見 [CONTRIBUTING.md](./CONTRIBUTING.md)（英文）。

我們歡迎各種形式的貢獻！無論是回報 Bug、建議功能、協助翻譯還是貢獻程式碼，請查看我們的 [貢獻指南](./CONTRIBUTING.md) 開始參與。
