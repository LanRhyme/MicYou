...
首先，感谢您对为 MicYou 做出贡献的兴趣！我们欢迎所有类型的贡献，无论是错误报告、功能请求、代码贡献还是翻译。
...
MicYou 支持多种语言，具有强大的翻译系统。我们欢迎贡献者将 MicYou 翻译成您的语言！

### 通过 Crowdin 翻译（推荐）

最简单的贡献翻译的方式是通过 [Crowdin](https://crowdin.com/project/micyou)。无需本地开发设置：
...
翻译合并后，将通过 GitHub Actions 自动同步到存储库。
...
3. 在您的 PR 标题中包含英文和母语的语言名称，例如：Add xx(code) localization
