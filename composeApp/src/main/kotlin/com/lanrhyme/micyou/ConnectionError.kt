    ...
    suspend fun generateErrorDetails(
        ...
        return when (type) {
            ...
            ConnectionErrorType.FirewallBlocked -> ConnectionErrorDetails(
                type = type,
                originalMessage = originalMessage,
                localizedTitle = getString(R.string.errorFirewallBlockedTitle),
                localizedMessage = String.format(getString(R.string.errorFirewallBlockedMessage), port?.toString() ?: Constants.DEFAULT_TCP_PORT.toString()),
                recoverySuggestions = listOf(
                    getString(R.string.errorSuggestionAddFirewallRule),
                    getString(R.string.errorSuggestionRunAsAdmin)
                ),
                showHelpButton = true,
            ...
            ConnectionErrorType.PermissionDenied -> ConnectionErrorDetails(
                ...
                recoverySuggestions = listOf(
                    getString(R.string.errorSuggestionRunAsAdmin),
                    getString(R.string.errorSuggestionCheckAntivirus)
                )
            )
            ...
            ConnectionErrorType.AdminPrivilegeRequired -> ConnectionErrorDetails(
                type = type,
                originalMessage = originalMessage,
                localizedTitle = getString(R.string.errorAdminPrivilegeTitle),
                localizedMessage = getString(R.string.errorAdminPrivilegeMessage),
                recoverySuggestions = listOf(
                    getString(R.string.errorSuggestionRunAsAdmin)
                )
            )
