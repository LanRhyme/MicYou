...
fun PluginSyncWarningDialog(
    ...
    AlertDialog(
        ...
        title = {
            Text(stringResource(R.string.pluginSyncWarningTitle))
        },
        text = {
            Column(
                ...
                Text(
                    stringResource(R.string.pluginSyncWarningMessage),
        ...
        confirmButton = {
            Button(onClick = onOpenSettings) {
                Text(stringResource(R.string.pluginsSection))
            }
        },
        dismissButton = {
    ...
    Card(
        ...
        Row(
            ...
            Column(modifier = Modifier.weight(1f)) {
                ...
                Text(
                    "${stringResource(R.string.versionLabel)}: ${plugin.version}",
                    style = MaterialTheme.typography.bodySmall,
                    color = MaterialTheme.colorScheme.onSurfaceVariant
                )
                Text(
                    "${stringResource(R.string.missingOn)}: ${plugin.missingOnPlatform}",
