            ...
            <div class="bg-surface-bright rounded-2xl p-4 shadow-sm space-y-4">
              ...
              <div v-if="settings.nsEnabled" class="space-y-4 pt-2 border-t border-surface-variant/20">
                <div class="flex gap-2 mt-4">
                  <button v-for="type in [{id: 'DPDFNet', label: 'DPDFNet (ONNX)'}, {id: 'Ulunas', label: 'Ulunas (ONNX)'}, {id: 'PureVox', label: 'PureVox (ONNX)'}, {id: 'RNNoise', label: 'RNNoise'}, {id: 'Speexdsp', label: 'Speexdsp'}, {id: 'Lightweight', label: 'Lightweight'}]" :key="type.id"
